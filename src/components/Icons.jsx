...
export function MailIcon() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true">
      <path d="M2 4h20a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1zm1.4 2L12 12.45 20.6 6H3.4zM3 8.25V18h18V8.25l-9 6.75-9-6.75z" />
    </svg>
  )
}
...
/* Long thin arrows used by the carousel (like the reference's slide controls). */
export function ArrowLeft() {
  return (
    <svg viewBox="0 0 36 36" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M32 18H4M14 8 4 18l10 10" />
    </svg>
  )
}
...
export function ArrowRight() {
  return (
    <svg viewBox="0 0 36 36" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
      <path d="M4 18h28M22 8l10 10-10 10" />
    </svg>
  )
}
